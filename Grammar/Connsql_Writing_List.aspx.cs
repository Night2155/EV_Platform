...
namespace Grammar
{
    public partial class Connsql_Writing_List : System.Web.UI.Page
    {
        ...
        { 
            ...
            //打開連接
            conn.Open();
            SqlCommand cmd = new SqlCommand("SELECT TOP 18 Video_Title,VideoID,keywords FROM Writing_Table ORDER BY NEWID()", conn);//設定SQL指令
